            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={corteId} onValueChange={setCorteId}>
                  <SelectTrigger id="corte" className="w-full border-gray-300 focus:border-green-500 focus:ring-green-500">
            ...
            {operadores.slice(0, 3).map((operador, index) => (
              <div
                ...
                className={`bg-white p-6 rounded-lg border shadow-sm text-center ${
                  index === 0 ? "scale-105 shadow-xl" : index === 1 ? "scale-103 shadow-lg" : "scale-100 shadow-sm"
                }`}
              >
                <div className="flex justify-center mb-4">
                  {index === 0 ? <Trophy className="h-12 w-12 text-yellow-500 animate-pulse" /> : index === 1 ? <Medal className="h-12 w-12 text-gray-400" /> : <Award className="h-12 w-12 text-amber-700" />}
                </div>
